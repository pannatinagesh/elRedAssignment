...
import { Button, Card, CardContent, Drawer, IconButton, Paper, Stack, TextField, Typography } from '@mui/material';
...
const EditStatement = (props: any) => {
   ...
   return (
      <Drawer anchor="right" open={props.record.open} onClose={handleClose} sx={{ '& .MuiDrawer-paper': { minWidth: isDesktop ? '30%' : '300px', maxWidth: isDesktop ? '30%' : '300px', pb: '40px' } }}>
         <Paper sx={{ p: 3 }}>
